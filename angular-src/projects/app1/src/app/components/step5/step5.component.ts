...
export class Step5Component implements OnInit {
  ...
  ngOnInit(): void {
    this.dataService.getStep5Videos().subscribe((data: any) => {
      this.videos = data
      console.log(data)
    })
    this.dataService.getStep5().subscribe((data: any) => {
      this.step5 = data
      this.pagetitle = this.step5[0].title
      this.pagedescription = this.step5[0].description
      console.log(data)
    })
  }
  ...
  onStep5Submit(){
    ...
    this.dataService.postStep5(step5).subscribe((data:any) => {
      if (data.success) {
        console.log(data)
  ...
  onVideoSubmit(){
    ...
    this.dataService.postStep5Videos(video).subscribe((data:any) => {
      if (data.success) {
        console.log(data)
        window.location.reload();
      } else {
